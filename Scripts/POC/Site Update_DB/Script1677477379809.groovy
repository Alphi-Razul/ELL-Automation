...
for(int r=1;r<=row;r++){
	...
	String ExistingSiteName=rows.getCell(1).getStringCellValue()
	println (ExistingSiteName)
	
	String siteId=rows.getCell(2).getStringCellValue()
	println (siteId)
	
	//Execute ---> Update Query 
	statement.executeUpdate("update sites set address = '"+Updatedaddress+"' where siteId='"+siteId+"'")
