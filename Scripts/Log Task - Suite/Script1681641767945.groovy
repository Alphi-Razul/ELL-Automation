...
WebUI.waitForElementVisible(findTestObject('LogTask-Ready_Status/verifyReadySt_inInstrument'), 1)
...
WebUI.click(findTestObject('LogTask-Status-A-Z/click_HeaderTag'))

//Default Log Status -------> Screenshot
WebUI.scrollToElement(findTestObject('LOT/button-EditLot'),0)
